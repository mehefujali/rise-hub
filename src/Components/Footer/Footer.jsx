      ...
      return (
            <footer className="footer footer-center bg-base-200 text-base-content rounded p-10">
                  <nav className="grid grid-flow-col gap-4">
                        ...
                        {user && <NavLink to="/myCampaign" className="text-black link link-hover dark:text-white">
                              My Campaign
                        </NavLink>}
                        {user && <NavLink to="/mydonations" className="text-black link link-hover dark:text-white">
                              My Donations
                        </NavLink>}
                  </nav>
                  <nav>
                  ...
                  <aside>
                        <p>Copyright © {new Date().getFullYear()} - All right reserved by Rise hub</p>
                  </aside>
            </footer>
      );
};
